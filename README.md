...
```bash
curl https://raw.githubusercontent.com/JorritSalverda/evohome-hgi80-listener/master/k8s/deployment.yaml | HGI_USB_PATH="/dev/ttyUSB0" CONTAINER_TAG='0.1.6' envsubst \$HGI_USB_PATH,\$CONTAINER_TAG | kubectl apply -f -
```
